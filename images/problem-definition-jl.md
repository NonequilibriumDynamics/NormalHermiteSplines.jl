...
The Bessel Potential space ``H^s_\varepsilon (R^n)`` is a  Reproducing kernel Hilbert space, an element ``f`` from that space can be treated as a ``r``-times continuously differentiable function.
